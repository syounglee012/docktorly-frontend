          ...
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 lg:w-1/2">
              <SectionTitle
                ...
                paragraph="At Docktorly, we understand the challenges that direct
              ...
              >
                <div className="mx-[-12px] flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="HIPPA compliant" />
                    <List text="Broad network in multiple states" />
                    <List text="24/7 customer service" />
                  </div>

                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="No long term commitment" />
                    <List text="Secure payment method" />
                  </div>
                </div>
              </div>
            </div>
